...
I have also built simple [microservice type react app](https://github.com/iamtomhewitt/home-dashboard-list-uploader) to keep an online list that can be accessed from iPhones.